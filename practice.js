...
var strings = ["howdy", "adios"];
var bigger = strings.map(function (string) {
...
var values = [34, 2, 1];
var added = values.map(function (value) {
  return value + 7;
});
console.log(added);
...
var number = seasons.map(function (season) {
...
var strings = ["heaven", "hell", "earth"];
var letter = strings.map(function (string) {
  return string[0];
});
console.log(letter);
...
var older = people.map(function (person) {
  return person.age * 2;
});
console.log(older);
