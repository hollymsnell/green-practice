...
var capitals = { michigan: "lansing", florida: "tallahassee", nevada: "reno" };
capitals["louisiana"] = "baton rouge";
console.log(capitals);

// # 7. Make a hash to store a laptop's brand, model, and year. Then print each attribute on separate lines.

var laptop = { brand: "apple", model: "macbook air", year: "2022" };
...
var laptops = [
  { brand: "apple", model: "macbook air", year: "2022" },
  { brand: "toshiba", model: "something", year: "2022" },
  { brand: "apple", model: "macbook pro", year: "2022" },
];
console.log(laptops[1].model);

// # 9. Make a hash to store definitions for 2 different words. Then add a new word and definition and print the hash to see the result.

var definition = { concur: "to agree with", highfive: "to slap hands with another as a form of celebration or unity" };
definition["cat"] = "one of the wildest domesticated land animals";
console.log(definition);

// # 10. Make a hash to store a shirt's brand, color, and size. Then print each attribute on separate lines.

var shirt = { brand: "hanes", color: "blue", size: "medium" };
