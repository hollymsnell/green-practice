...
strings = ["winner", "winner", "chicken", "dinner"]
w_words = strings.select do |string|
  string[0] == "w"
end
p w_words
...
hashes = [{name: "chair", price: 100}, {name: "pencil", price: 1}, {name: "book", price: 4}] 
expensive = hashes.select do |hash|
  hash[:price] > 5
end
p expensive
...
strings = ["a", "man", "be", "plan", "key", "canal", "panama"]
short_words = strings.select do |string|
  string.length < 4
end
p short_words
...
hashes = [{name: "chair", price: 100}, {name: "pencil", price: 1}, {name: "book", price: 4}] 
short_names = hashes.select do |hash|
  hash[:name].length < 6
end
p short_names
...
numbers = [8, 23, 0, 44, 1980, 3]
ten_less = numbers.select do |number|
  number < 10
end
p ten_less
...
strings = ["big", "little", "good", "bad"]
no_b_words = strings.select do |string|
  string[0] != "b"
end
p no_b_words
...
hashes = [{name: "chair", price: 100}, {name: "pencil", price: 1}, {name: "book", price: 4}] 
low_price = hashes.select do |hash|
  hash[:price] < 10
end
p low_price
